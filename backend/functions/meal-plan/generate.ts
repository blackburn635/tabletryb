/** Meal plan: generate — see API.md for endpoint details */
...
export const handler = async (event: APIGatewayProxyEventV2WithJWTAuthorizer): Promise<APIGatewayProxyResultV2> => {
  try {
    ...
    // TODO: Implement generate logic (port from prototype)
    return success({ message: 'Not yet implemented: meal-plan/generate' });
